...
Notice that the first part of the sequence is the prompt, which is the actual sequence from a real *gyrA* gene, indicated in organge in tis [image](<>).
Notice that the remainder of the sequence is the synthetic sequence, generated by Evo 2
(indicated in yellow in this [image](<>)).
